...
<AutomatedCarousel />
        ...
        <div className="aboutus">
          ...
          <div className="aboutustext center ">
            ...
            community and their alma mater, IIT Roorkee. Operating under the
            aegis of the Dean of Resources and Alumni Affairs (DORA), IIT
            Roorkee, IARC is dedicated to its mission of fostering and nurturing
            an enduring connection and relationship between our cherished alumni
            and their beloved alma mater. This bond is meticulously cultivated
        ...
        <div className="teamm">
          ...
          <div className="leftspace sizeread othermemm">
            <a href="/team">
              <img src={othermem} alt="" />
            </a>
          </div>
        </div>
      </div>
